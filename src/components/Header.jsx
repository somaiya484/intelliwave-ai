...
import image from '../assets/notification/images-removebg-preview.png'
...
const Header = () => {
    ...
    return (
        <div className={`fixed top-0 left-0 w-full z-50 bg-n-8/90 backdrop-blur-sm border-b border-n-6 lg:bg-n-8/90 lg:backdrop-blur-sm ${openNavigation ? "bg-n-8" : "bg-n-8 backdrop-blur-sm"}`}>

            <div className="flex items-center px-5 lg:px-7.5 xl:px-10 max-lg:py-4">
                <a className=" w-[12rem] xl:mr-8 flex items-center" href="#hero">
                    <img src={image} width={70} height={40} alt="BrainWave" />Intelli Wave AI
                </a>
